...
public interface ProjectDao {
    ...
    void addTable(@Param("tableName") String tableName, @Param("columnStringList") List<String> columnStringList, @Param("pk") String pk);
     ...
     * @return
     */
    long updateProject(@Param("tableName") String tableName, @Param("project") AppProject appProject, @Param("columnNames") List<String> columnNames);
     ...
     * @return
     */
    void addProject(@Param("tableName") String tableName, @Param("project") AppProject appProject, @Param("columnNames") List<String> columnNames);

    void addProjectTest(@Param("tableName") String tableName,@Param("project") AppProject appProject,@Param("columnNames") List<String> columnNames);
    /**
     * 验证用户权限
     *
     * @param tableName
